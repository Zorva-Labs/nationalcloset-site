...
- `--accent-ink` (#B9542F) on `--accent-soft` (#F6E6DF) measures 3.96:1 — under WCAG AA. New CRM text on that pairing should use `--crew-deep` (#A8481F, 4.79:1); the older components that use `--accent-ink` have not been revisited.
