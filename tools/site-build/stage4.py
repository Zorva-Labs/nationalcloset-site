...
CAB_FAQ = [
  ...
  ('Are custom cabinets covered by your warranty?',
   'Yes. Custom cabinets carry the same lifetime warranty as our closet systems: the cabinet boxes, doors, drawer boxes and fronts, shelving, hinges, slides and hardware are warranted against defects in materials and manufacturing for as long as you own your home, and our installation workmanship is guaranteed for one year. When damage isn\'t a defect — a dropped pan, a move, years of wear — we can order matching replacement parts at cost. <a class="inline" href="/warranty">Read the full warranty.</a>'),
...
def update_homepage():
    ...
    def fix(m):
        ...
        if '@graph' in d:
            ...
            d['description'] = "Beautiful custom-designed closets and custom cabinets at a price normal families can afford — custom closet systems, professionally designed and installed: walk-in and reach-in closets, closet organizers, custom kitchen cabinets and islands, bathroom vanities, laundry and mudroom cabinetry, built-in hutches and media walls, custom pantries and pantry cabinets, home offices and garage storage."
