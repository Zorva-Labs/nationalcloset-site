...
const FALLBACK_TERMS = {
  custom_order: MATERIALS_LEADTIME + PAYMENT_SCHEDULE + `<h3>Warranty</h3><p>Lifetime warranty on the system (panels, shelving, drawers, rods, brackets, hinges, slides and hardware) against defects in materials and manufacturing for as long as the original customer owns the home, plus a one-year workmanship guarantee from the date of installation. Warranty parts stay free after the first year; a standard service-call fee then covers the trip and labor to install them. Not transferable.</p>` + RENTAL_CLAUSE,
  wallprep: MATERIALS_LEADTIME + `<h3>Wall Repair &amp; Paint</h3><p>We remove the existing shelving, patch and repair the walls, and paint the immediate installation area before the new system goes in.</p>` + PAYMENT_SCHEDULE + `<h3>Warranty</h3><p>Lifetime warranty on the system (panels, shelving, drawers, rods, brackets, hinges, slides and hardware) against defects in materials and manufacturing for as long as the original customer owns the home, plus a one-year workmanship guarantee from the date of installation. Warranty parts stay free after the first year; a standard service-call fee then covers the trip and labor to install them. Not transferable.</p>` + RENTAL_CLAUSE,
